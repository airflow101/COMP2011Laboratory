...
const char *customer_types[] = { "VIP", "Regular-member", "Non-member" };

int main() {
	Customer* head = NULL;
	Customer* p1 = new_customer("Adam", customer_types[2]);
	Customer* p2 = new_customer("Betty", customer_types[1]);
	Customer* p3 = new_customer("Chris", customer_types[1]);
	Customer* p4 = new_customer("Doris", customer_types[0]);
	Customer* p5 = new_customer("Eric", customer_types[2]);
